        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TokenConfirmacaoEmail = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TokenResetSenha = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DataExpiracaoTokenReset = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    TentativasLoginFalhadas = table.Column<int>(type: "int", nullable: false),
                    ContaBloqueada = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    DataBloqueio = table.Column<DateTime>(type: "datetime(6)", nullable: true),
